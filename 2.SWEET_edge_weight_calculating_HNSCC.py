# -*- coding: utf-8 -*-
"""
Created on Thu Sep 16 20:28:55 2021
...
# # parser.add_argument("-w", type=str , default="./example/HNSCC_58samples_100genes_weight.txt" , help="weight file")#weight profile
...
def sweet2(file_e, file_p, save_path) :
    ...
    del value , agg , patloc , value_s , p , weight , l , g1 , v1
